...
data class SuperHeroDetail(
    ...
    @SerializedName("image") val image: ImageDetailResponse
)

data class ImageDetailResponse(@SerializedName("url") val url: String = "")
...
data class PowerstatsDetailResponse(
    ...
    @SerializedName("strenght") val strength: String = "",
